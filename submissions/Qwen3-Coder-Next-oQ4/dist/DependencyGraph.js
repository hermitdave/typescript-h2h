...
class DependencyGraph {
    ...
    removeDependency(taskId, dependencyId) {
        ...
        if (!deps || !dependents)
            return false;
        if (!deps.has(dependencyId) || !dependents.has(taskId))
            return false;
     ...
     */
    wouldCreateCycle(taskId, dependencyId) {
     ...
     */
    hasPath(start, end, maxDepth = 1000) {

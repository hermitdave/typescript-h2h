...
export declare const TASK_SUCCEEDED_STATUSES: Readonly<Set<TaskStatus>>;
/** Statuses after which a hard dependent must be considered faulted. */
export declare const TASK_FAILED_STATUSES: Readonly<Set<TaskStatus>>;
/** Every status that "closes" a task for the purposes of fan-out. */
export declare const TERMINAL_STATUSES: Readonly<Set<TaskStatus>>;
/** Specification used to register a task, without running it. */
export interface TaskSpec<TArgs extends unknown[] = unknown[], TReturn = unknown> {
 ...
 */
export interface Task<TArgs extends unknown[] = unknown[], TReturn = unknown> {
    readonly id: string;
...
export interface PublicTask<TArgs extends unknown[] = unknown[], TReturn = unknown> {
    readonly id: string;
    readonly name: string;
...
export interface Stats<TArgs extends unknown[] = unknown[], TReturn = unknown> {
    total: number;
